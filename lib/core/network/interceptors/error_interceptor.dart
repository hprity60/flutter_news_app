...
class ErrorInterceptor extends InterceptorsWrapper {
  ...
  void onError(DioError err, ErrorInterceptorHandler handler) {
    ...
    if (err.type == DioErrorType.connectionTimeout ||
      ...
      //     (err.error.toString())
      //         .contains("Bad request. Please check your input.")) {
      //   errorMessage = "Bad request. Please check your input.";
      // }

      // if (err.response != null && err.response!.statusCode == HttpStatus.badRequest) {
      //   try {
      ...
      //       errorMessage = errorResponse["message"].toString().replaceAll(from, replace);
      //     }
      //   } catch (e) {
      //     throw err; // Rethrow the original exception
      //   }
